    ...
    execute(message, args) {
        ...
        const libEmbed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    {name: "Finding A Clip:", value: "`To find your favorite clip first you have to open the GoogleSheet where everything is saved. You can get the link with the $library command. Next use the ctrl+F function to search for the keyword you are looking for.`"},
                    ...
                    {name: "The Lookup Command:", value: "`This command used with a clip link will check if the clip is already in the library or not. If it is, Clippy Bot will provide the current keywords for that clip.`"},
